...
const mockTranslate = (key: string, params?: Record<string, unknown>) => {
      ...
      const translations: Record<string, string> = {
        ...
        "settings.defaultOpenCodePath": "Default OpenCode CLI path",
        "settings.openCodePlaceholder": "opencode",
        ...
        "settings.clientUiVisibility.controls.bottomActivityCheckpoint": "Overview tab",
        "settings.clientUiVisibility.controls.bottomActivityCheckpointDetails": "Overview details",
        ...
        "settings.openInHelp": "Commands receive the selected path as the final argument. Apps launch via the OS (macOS open, Windows executable or PATH command).",
        "settings.typeFileManagerMac": "Finder",
        "settings.typeFileManagerWindows": "File Explorer",
        "settings.typeFileManagerLinux": "File manager",
        "settings.addOpenAppTitle": "Add open target",
        "settings.addOpenAppDesc": "Pick a detected app, browse for an executable, or add a custom command.",
        "settings.browseApplication": "Browse application…",
        "settings.addCustomCommand": "Custom command…",
        "settings.openAppPresetSearch": "Search apps",
        "settings.openAppPresetFileManagerHint": "Reveal in the system file manager",
        "settings.openAppHealthOk": "Available",
        "settings.openAppHealthMissing": "Not found",
        "settings.openAppHealthBroken": "Broken",
        "settings.openAppHealthUnknown": "Unchecked",
        "settings.openAppHealthRefreshing": "Checking…",
        "settings.openAppHealthClickToVerify": "Click to re-check",
        "settings.appNamePlaceholder": "App name or path",
        "settings.appNameHelp": "Enter a name or browse.",
        ...
        "statusPanel.tabCheckpoint": "Overview",
        ...
        "statusPanel.sessionOverview.title": "Overview",
        ...
        "statusPanel.sessionOverview.contextLabel": "Context",
        "statusPanel.sessionOverview.rateLimitLabel": "Rate limit",
        "statusPanel.sessionOverview.percent": "{{percent}}%",
        "statusPanel.sessionOverview.sessionDiskPathUnknown":
          "Session file path not resolved",
        "statusPanel.sessionOverview.fields.sessionId": "Session",
        "statusPanel.sessionOverview.fields.workspace": "Workspace",
        ...
        "statusPanel.sessionOverview.quota.genericTitle": "Account limits",
        "statusPanel.sessionOverview.quota.loading": "Loading limits…",
        "statusPanel.sessionOverview.quota.codexEmpty":
          "Codex is connected, but no limit windows are available yet (refresh usage from the config menu).",
        "statusPanel.sessionOverview.quota.codingPlanEmpty":
        ...
        "messages.middleStepsCollapsedHint": "已处理 · {{count}} 步",
        "messages.middleStepsProcessed": "已处理",
        "messages.middleStepsProcessedWithDuration": "已处理 {{duration}}",
        "messages.middleStepsProcessedSteps": "{{count}} 步",
        "messages.middleStepsStatReasoning": "思考 {{count}} 次",
        "messages.middleStepsStatTool": "工具调用 {{count}} 次",
        "messages.middleStepsStatExplore": "探索 {{count}} 次",
        "messages.middleStepsProcessedAria": "{{state}}过程摘要：{{detail}}",
        "messages.middleStepsExpandAction": "展开",
        "messages.middleStepsCollapseAction": "收起",
        "messages.collapseMiddleStepsEnable": "完成后自动收起中间过程",
        "messages.collapseMiddleStepsDisable": "始终展开中间过程",
